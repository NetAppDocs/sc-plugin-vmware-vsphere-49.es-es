...
Debe revisar la información relacionada con lo que hace el plugin de VMware de SnapCenter y no admite.
link:scpivs44_deployment_planning_and_requirements.html["Planificación y requisitos de la puesta en marcha"]
