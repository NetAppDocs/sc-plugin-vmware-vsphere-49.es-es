...
+
No utilice los siguientes caracteres especiales en los nombres de máquinas virtuales, almacenes de datos, políticas, backups o grupos de recursos: & * $ # @ ! \ / : * ? " < > - | ; ' , . Se permite el carácter de guion bajo (_).
