...
. En la pestaña Configurar, seleccione una copia de seguridad y haga clic en *Renombrar*.
. En el cuadro de diálogo *Renombrar copia de seguridad*, introduzca el nuevo nombre y haga clic en *Aceptar*.
+
No utilice los siguientes caracteres especiales en los nombres de máquinas virtuales, almacenes de datos, políticas, copias de seguridad o grupos de recursos: & * $ # @ ! \ / : * ?  " < > - | ; ' , y espacio. Se permite un carácter de subrayado (_).
